...
namespace XoopsModules\Xlanguage\Form;
 ...
 */
class LanguageForm extends \Xoops\Form\ThemeForm
{
    /**
     * @param \XoopsModules\Xlanguage\Language|null $obj
     */
    public function __construct(\XoopsModules\Xlanguage\Language $obj = null)
    {
        ...
        $flagPath = 'media/xoops/images/flags/' . \XoopsModules\Xlanguage\Helper::getInstance()->getConfig('theme') . '/';
        ...
        $image_select->setExtra("onchange='showImgSelected(\"image\", \"xlanguage_image\", \"/media/xoops/images/flags/" . \XoopsModules\Xlanguage\Helper::getInstance()->getConfig('theme') . '/", "", "' . \XoopsBaseConfig::get('url') . "\")'");
        $image_tray = new \Xoops\Form\ElementTray('', '&nbsp;');
        $image_tray->addElement($image_select);
        $image_tray->addElement(new \Xoops\Form\Label('', "<div style='padding: 8px;'><img style='width:24px; height:24px; ' src='" . \XoopsBaseConfig::get('url') . '/media/xoops/images/flags/' . \XoopsModules\Xlanguage\Helper::getInstance()->getConfig('theme') . '/' . $obj->getVar('xlanguage_image') . "' name='image' id='image' alt=''></div>"));
